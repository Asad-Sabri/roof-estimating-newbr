...
_s(ClientLayout, "mLsII5HRP5G63IA/8vjZ5YHXWr8=");
_c = ClientLayout;
var _c;
...
"[project]/redux/slices/productListingSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const productListingSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: "productListing",
    initialState,
    reducers: {
        setIsCompared: (state, action)=>{
            state.isCompared = action.payload;
        },
        setShowHeaderAdModal: (state, action)=>{
            state.showHeaderAdModal = action.payload;
        },
        setSaveVendorData: (state, action)=>{
            state.savedVendorData = action.payload;
        },
        setRedirectProductId: (state, action)=>{
            state.redirectProductId = action.payload; // ✅ new action
        },
        setRedirectAddToCartData: (state, action)=>{
            state.redirectAddToCartData = action.payload;
        },
        addToCompare: (state, action)=>{
            const exists = state.compareList.some((item)=>item.title === action.payload.title);
            if (!exists) {
                state.compareList.push(action.payload);
            }
        },
        removeFromCompare: (state, action)=>{
            state.compareList = state.compareList.filter((item)=>item.title !== action.payload);
        },
...
const { setIsCompared, setSaveVendorData, addToCompare, removeFromCompare, clearCompareList, setShowHeaderAdModal, setRedirectProductId, setRedirectAddToCartData, setCart, setSelectedCartItems, clearSelectedCartItems } = productListingSlice.actions;
const __TURBOPACK__default__export__ = productListingSlice.reducer;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/utils/cookieStorage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const cookieStorage = {
    getItem: (key)=>{
        return Promise.resolve(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(key) || null);
    },
    setItem: (key, value)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].set(key, value, {
            expires: 30,
            path: "/"
        });
    ...
    removeItem: (key)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].remove(key, {
            path: "/"
        });
        return Promise.resolve();
    }
};
const __TURBOPACK__default__export__ = cookieStorage;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$slices$2f$productListingSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/redux/slices/productListingSlice.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$cookieStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/cookieStorage.ts [app-client] (ecmascript)");
;
;
;
;
...
const rootReducer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2f$dist$2f$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineReducers"])({
    ...
    productListing: __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$slices$2f$productListingSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
});
const persistConfig = {
    key: "root",
    storage: __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$cookieStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
    whitelist: [
        "auth"
    ]
};
...
const ReduxProvider = (param)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Provider"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2d$persist$2f$es$2f$integration$2f$react$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PersistGate"], {
            loading: null,
            persistor: __TURBOPACK__imported__module__$5b$project$5d2f$redux$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persistor"],
            children: children
        }, void 0, false, {
...
"[project]/redux/ReactQueryProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ReactQueryProvider(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
        ...
        fileName: "[project]/redux/ReactQueryProvider.tsx",
        lineNumber: 15,
        columnNumber: 5
    }, this);
}
...
//# sourceMappingURL=_67db7f46._.js.map